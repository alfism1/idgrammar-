...
<head>
  ...
  <title>Bahasa Indonesia Grammar Checker Test</title>
</head>
<body>
  <div class="container">
    <br>
    ...
    //
    // echo "ID Rule semua : ";
    // print_r($idgrammar["id"]);
    //
    // echo "Proses POS Tagging menghasilkan kelas kata<br>";
    // print_r( $idgrammar["tag"]->result );
    //
    // echo "<br><br><br>Format POS Tagging<br>";
    // print_r( $idgrammar["tag"]->fulltag );
    //
    // echo "<br><br><br>Pecah per kalimat<br>";
    // print_r( $idgrammar["kalimat"] );
    //
    // echo "<br><br><br>Match rule tata bahasa<br>";
    // print_r( $idgrammar["tatab"] );
    //
    // echo "<br><br><br>Setelah cek pertama menghasilkan format ~token~<br>";
    // print_r( $idgrammar["token"] );
    //
    // echo "<br><br><br>Match rule tata tulis<br>";
    // print_r( $idgrammar["tatat"] );
    //
    // echo "</pre>";
    ?>
